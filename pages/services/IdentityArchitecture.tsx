  ...
  const faqs = [
    {
      ...
      answer: "Websites built for machine parsing and human conversion using modern static stacks, ensuring consistency across all AI search engines."
    },
    {
      question: "What does your Visual Design System include?",
      answer: "Comprehensive UI kits and visual guidelines built for rapid deployment across multi-stack platforms, maintaining brand integrity."
    }
  ];
      ...
      <section className="bg-slate-900 text-white py-32">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl">
            <h1 className="text-6xl font-black tracking-tighter mb-8 leading-none">Identity <br/><span className="text-[#FF6B00]">Architecture.</span></h1>
        ...
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          <div>
            ...
            <div className="space-y-6 text-slate-600 leading-relaxed text-lg">
              <p>Most branding projects end with a logo. Our <strong>Identity Architecture</strong> ends with a deployable system. We build the frameworks that ensure every digital touchpoint—from your UI to your automated emails—speaks the same high-level language.</p>
              <p>In the age of AI, brand consistency is a technical requirement. We ensure your brand identity is machine-readable and human-compelling.</p>
            </div>
          ...
          <div className="aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl border border-slate-100">
            <GeminiImage 
              prompt="Minimalist high-end brand guidelines book on a marble table, professional typography, clean layout, architectural studio setting" 
