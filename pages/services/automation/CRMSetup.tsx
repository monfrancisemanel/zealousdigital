  ...
  const faqs = [
    {
      ...
      answer: "We specialize in HubSpot and Salesforce, but we also build custom CRM bridges for specialized industries that require proprietary database logic."
    },
    {
      question: "Can you migrate our legacy data?",
      answer: "Yes. We handle technical data cleaning and mapping to ensure your historical context is preserved while eliminating the 'garbage in, garbage out' cycle."
    }
  ];
    ...
    <main className="bg-white text-slate-900">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl">
              <h1 className="text-5xl lg:text-7xl font-black tracking-tighter mb-8 leading-none">
                CRM <br/><span className="text-[#FF6B00]">Engineering.</span>
              </h1>
            ...
            <div className="hidden lg:block aspect-video rounded-2xl overflow-hidden shadow-2xl border border-white/10">
              <GeminiImage 
                prompt="Clean database visualization on a laptop, corporate office environment, focus on organized columns and orange data points" 
      ...
      <section className="py-24 lg:py-32 border-b border-slate-50">
        <div className="container mx-auto px-4 lg:px-8 max-w-5xl">
          <h2 className="text-sm font-bold uppercase tracking-[0.4em] text-[#FF6B00] mb-8">The Operational Friction</h2>
      ...
      <section className="py-32 bg-slate-50 border-t border-slate-100">
        <div className="container mx-auto px-4 lg:px-8 max-w-3xl">
          <h2 className="text-3xl font-black text-slate-900 mb-16 text-center text-balance">Infrastructure FAQ</h2>
      ...
      <section className="bg-slate-900 text-white py-32 text-center border-t border-slate-800">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl lg:text-6xl font-black mb-8 tracking-tighter">Your pipeline is <span className="text-[#FF6B00]">leaking.</span></h2>
