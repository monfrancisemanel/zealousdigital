  ...
  const faqs = [
    {
      ...
      answer: "We utilize A2P 10DLC registration and strict opt-in logic to ensure high delivery rates and brand compliance with carrier regulations."
    },
    {
      question: "Can these systems integrate with our existing CRM?",
      answer: "Yes. We primarily build logic inside HubSpot or Salesforce, but can also bridge data between custom stacks using API orchestration."
    }
  ];
    ...
    <main className="bg-white text-slate-900">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl">
              <h1 className="text-5xl lg:text-7xl font-black tracking-tighter mb-8 leading-none">
                Persistent Lead <br/><span className="text-[#FF6B00]">Nurture Orchestration.</span>
              </h1>
            ...
            <div className="hidden lg:block aspect-video rounded-2xl overflow-hidden shadow-2xl border border-white/10">
              <GeminiImage 
                prompt="Modern smartphone showing elegant automated notifications, clean minimalist branding, cinematic studio lighting" 
      ...
      <section className="bg-slate-900 text-white py-32 text-center border-t border-slate-800">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl lg:text-6xl font-black mb-8 tracking-tighter">Your leads are <span className="text-[#FF6B00]">cooling off.</span></h2>
