...
const ProgrammaticSEO: React.FC = () => {
  return (
    <main className="bg-white text-slate-900">
      <SEO 
        title="Programmatic SEO & Large-Scale Authority Vancouver"
        description="Engineering large-scale visibility assets using programmatic logic and entity mapping for Vancouver based organizations. Scale your reach."
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl">
              <h1 className="text-5xl lg:text-7xl font-black tracking-tighter mb-8 leading-none">
                Algorithmic <br/><span className="text-[#FF6B00]">Scale Strategy.</span>
              </h1>
      ...
      <section className="py-24 lg:py-32 border-b border-slate-50">
        <div className="container mx-auto px-4 lg:px-8 max-w-5xl">
          <h2 className="text-sm font-bold uppercase tracking-[0.4em] text-[#FF6B00] mb-8">The Scale Problem</h2>
          <p className="text-3xl lg:text-4xl font-black text-slate-900 tracking-tight leading-tight mb-8">
            Most businesses come to us when they reach the limits of manual content production.
          </p>
      ...
      <section className="bg-slate-50 py-24 border-b border-slate-100">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl font-black tracking-tighter text-slate-900 mb-8">Entity & LSI Logic</h2>
