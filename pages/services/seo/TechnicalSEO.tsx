...
const TechnicalSEO: React.FC = () => {
  return (
    <main className="bg-white text-slate-900">
      <SEO 
        title="Enterprise Technical SEO & Core Web Vitals Vancouver"
        description="Engineering technical cores—meta logic, H1 hierarchy, and global edge delivery—required for elite visibility and search performance in Vancouver, BC."
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl">
              <h1 className="text-5xl lg:text-7xl font-black tracking-tighter mb-8 leading-none">
                Infrastructural <br/><span className="text-[#FF6B00]">Integrity.</span>
              </h1>
              <p className="text-xl lg:text-2xl text-slate-400 leading-relaxed mb-12">
                We engineer the technical core—meta logic, H1 hierarchy, and global edge delivery—required for elite visibility performance.
              </p>
      ...
      <section className="py-24 lg:py-32 border-b border-slate-50">
        <div className="container mx-auto px-4 lg:px-8 max-w-5xl">
          ...
          <p className="text-3xl lg:text-4xl font-black text-slate-900 tracking-tight leading-tight mb-8">
            Most businesses come to us when their site speed is a strategic liability.
          </p>
          <div className="text-lg text-slate-600 space-y-6 leading-relaxed">
            <p>
              Search engines and LLMs prioritize speed and structural clarity. If your core web vitals are failing, your content authority is irrelevant. Technical SEO is the foundation of digital trust.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-slate-50 py-24 border-b border-slate-100">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl font-black tracking-tighter text-slate-900 mb-8">Hard-Wired Visibility</h2>
              <ul className="space-y-6">
                <li className="flex gap-4 items-start">
                  <span className="w-1.5 h-6 bg-[#FF6B00] shrink-0"></span>
                  <div>
                    <strong className="block text-slate-900 text-sm uppercase tracking-widest mb-1">Crawl Budget Optimization</strong>
                    <p className="text-slate-500 text-sm">Pruning technical bloat to ensure search bots prioritize revenue-driving assets.</p>
                  </div>
                </li>
              </ul>
            </div>
