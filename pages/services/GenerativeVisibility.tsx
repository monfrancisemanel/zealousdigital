        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl">
            <h1 className="text-6xl font-black tracking-tighter mb-8 leading-none">
              Generative <br/><span className="text-[#FF6B00]">Visibility.</span>
            </h1>
      ...
      <div className="container mx-auto px-4 lg:px-8 py-32">
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          <div className="aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl border border-slate-100">
            <img
              src="/images/generative-visibility.jpg"
              alt="AI neural network and knowledge signals"
          ...
          <div>
            ...
            <div className="space-y-6 text-slate-600 leading-relaxed text-lg">
              <p>
                Decision makers are bypassing Google and asking ChatGPT, Claude, and Perplexity for solutions. If your data isn't structured for <strong>Generative Engine Optimization (GEO)</strong>, your brand doesn't exist to them.
              </p>
              <p>
                We deploy semantic knowledge signals that ensure AI models trust and cite your business as the category leader.
              </p>
            </div>
