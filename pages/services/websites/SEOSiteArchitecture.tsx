  ...
  const faqs = [
    {
      ...
      answer: "Content without architecture is just noise. If search engines can't understand the relationship between your pages, they won't assign you authority, no matter how much you write."
    },
    {
      question: "Why use static sites for SEO?",
      answer: "Google prioritizes speed and structural clarity. Static architectures eliminate the database lag inherent in WordPress, providing instant response times that boost rankings."
    }
  ];
    ...
    <main className="bg-white text-slate-900">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="hidden lg:block aspect-video rounded-2xl overflow-hidden shadow-2xl border border-white/10">
              <GeminiImage 
                prompt="Abstract digital architecture representing a clean website hierarchy, isometric view, glowing paths and nodes" 
      ...
      <section className="bg-slate-900 text-white py-32 text-center border-t border-slate-800">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl lg:text-6xl font-black mb-8 tracking-tighter">Your foundation is <span className="text-[#FF6B00]">leaking data.</span></h2>
