  ...
  const faqs = [
    {
      ...
      answer: "Proprietary builders create technical debt and slow load times. We build 'no lock-in' static sites that belong to you, perform 3x faster, and have zero monthly builder fees."
    },
    {
      question: "How do you track performance without cookies?",
      answer: "We utilize privacy-first, server-side tracking and deep CRM integrations to measure true pipeline impact, not just superficial clicks."
    }
  ];
    ...
    <main className="bg-white text-slate-900">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl">
              <h1 className="text-5xl lg:text-7xl font-black tracking-tighter mb-8 leading-none">
                High-Performance <br/><span className="text-[#FF6B00]">Conversion Hubs.</span>
              </h1>
            ...
            <div className="hidden lg:block aspect-video rounded-2xl overflow-hidden shadow-2xl border border-white/10">
              <GeminiImage 
                prompt="Modern luxury landing page UI design, ultra-fast loading speed representation, minimal aesthetic, sleek interaction elements" 
      ...
      <section className="bg-slate-900 text-white py-32 text-center border-t border-slate-800">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl lg:text-6xl font-black mb-8 tracking-tighter">Stop leaking <span className="text-[#FF6B00]">pipeline.</span></h2>
