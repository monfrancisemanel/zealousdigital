  ...
  const faqs = [
    {
      ...
      answer:
        "Deep technical configuration of your sales stack to capture every data point from the first click, ensuring data integrity across the pipeline."
    },
    {
      question: "How does Pipeline Orchestration improve ROI?",
      answer:
        "Automated logic ensures leads move through your funnel with zero manual intervention, reducing response time and increasing conversion probability."
    }
  ];
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl">
            <h1 className="text-6xl font-black tracking-tighter mb-8 leading-none">
              Revenue <br /><span className="text-[#FF6B00]">Operations.</span>
            </h1>
      ...
      <div className="container mx-auto px-4 lg:px-8 py-32">
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          ...
          <div className="order-2 lg:order-1 aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl border border-slate-100">
            <img
              src="/images/revenue-operations.jpg"
              alt="Revenue operations dashboards and pipeline analytics"
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-6 text-slate-600 leading-relaxed text-lg">
              <p>
                Your CRM shouldn&apos;t just be a database; it should be an intelligence hub. We engineer <strong>Revenue Operations</strong> frameworks that eliminate lead friction and provide absolute clarity on your customer acquisition costs.
              </p>
              <p>
                We specialize in HubSpot, Salesforce, and custom CRM engineering, ensuring your sales team only talks to qualified leads.
              </p>
            </div>
