        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl">
            <h1 className="text-6xl font-black tracking-tighter mb-8 leading-none">
              Operational <br/><span className="text-[#FF6B00]">Orchestration.</span>
            </h1>
        ...
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          <div>
            ...
            <div className="space-y-6 text-slate-600 leading-relaxed text-lg">
              <p>
                Manual work is the silent killer of enterprise growth. We deploy <strong>Intelligent Automation</strong> systems that handle everything from multi-step lead processing to automated operational reporting.
              </p>
              <p>
                We build logic bridges between your siloed tools, creating a unified ecosystem that operates 24/7 without fatigue.
              </p>
            </div>
          ...
          <div className="aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl border border-slate-100">
            <img
              src="/images/operational-orchestration.jpg"
              alt="Workflow automation and system orchestration"
