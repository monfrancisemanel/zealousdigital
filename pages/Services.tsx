        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl">
            <h1 className="text-6xl font-black tracking-tighter mb-8 leading-none">
              Engineering <br/><span className="text-[#FF6B00]">Visibility.</span>
            </h1>
      ...
      <div className="container mx-auto px-4 lg:px-8 py-32 space-y-48">
        ...
        <section className="grid lg:grid-cols-2 gap-24 items-center">
          ...
          <div className="aspect-square rounded-3xl overflow-hidden shadow-2xl border border-slate-100">
            <img
              src="/images/services-identity.jpg"
              alt="Identity architecture and web performance"
        ...
        <section className="grid lg:grid-cols-2 gap-24 items-center">
          <div className="order-2 lg:order-1 aspect-square rounded-3xl overflow-hidden shadow-2xl border border-slate-100">
            <img
              ...
              alt="Operational orchestration and data systems"
              className="w-full h-full object-cover"
              loading="lazy"
            />
          </div>
        ...
        <section className="grid lg:grid-cols-2 gap-24 items-center">
          ...
          <div className="aspect-square rounded-3xl overflow-hidden shadow-2xl border border-slate-100">
            <img
              ...
              alt="Automation and voice assistant"
              className="w-full h-full object-cover"
              loading="lazy"
            />
          </div>
        ...
        <section className="grid lg:grid-cols-2 gap-24 items-center">
          <div className="order-2 lg:order-1 aspect-square rounded-3xl overflow-hidden shadow-2xl border border-slate-100">
            <img
              src="/images/services-visibility.jpg"
              alt="Search visibility strategy"
              className="w-full h-full object-cover"
              loading="lazy"
            />
          </div>
        ...
        <section className="grid lg:grid-cols-2 gap-24 items-center">
          ...
          <div className="aspect-square rounded-3xl overflow-hidden shadow-2xl border border-slate-100">
            <img
              src="/images/services-generative.jpg"
              alt="Generative visibility and AI hardware"
              className="w-full h-full object-cover"
              loading="lazy"
            />
          </div>
