  ...
  return (
    <div className="container mx-auto px-4 lg:px-8 py-24">
      ...
      <div className="max-w-3xl mb-24">
        ...
        <h2 className="text-6xl font-black tracking-tighter text-slate-900 mb-8 leading-none">
          The Future of <br />Search & Scale.
        </h2>
      ...
      <div className="grid md:grid-cols-2 gap-16">
        {[
          ...
          },
          {
            ...
            date: "JAN 10, 2025",
            img: "/images/resources-architecture.jpg",
          ...
          },
          {
            ...
            category: "Automation",
            date: "DEC 20, 2024",
            img: "/images/resources-ai-agents.jpg",
